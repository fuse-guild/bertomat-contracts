...
abstract contract ERC20Wrapper is ERC20 {
     ...
     */
    function depositFor(address account, uint256 amountEUR) public virtual returns (bool) {
     ...
     */
    function withdrawTo(address account, uint256 amountCFA) public virtual returns (bool) {
        _burn(account, amountCFA / 655);
        SafeERC20.safeTransfer(underlying, account, amountCFA);
        return true;
    }
